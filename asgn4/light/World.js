...
function addActionsForHtmlUI(){
  ...
  document.getElementById('lightColor').addEventListener('mousemove', function() { const t = this.value / 100;; g_lightColor[1] = 1.0 - t; g_lightColor[2] = 1.0 - t;});
...
function renderAllShapes() {
  ...
  let outRad = (g_spotlightDeg + 5) * Math.PI / 180; // controls harshness of my spotlight
  ...
  if (g_teapot && g_teapot.isFullLoaded) {
    ...
    g_teapot.matrix.scale(0.8, 0.8, 0.8);
